...
// ── Compounding curve ─────────────────────────────────────────────────────────
function CompoundingCurve({ portfolioValue, requiredCAGR, goalTarget }) {
  ...
  const curve = useMemo(() => {
    ...
    return pts;
  }, [portfolioValue, requiredCAGR, years, steps]);
  ...
  return (
    <div style={{ background: C.surface, border: `1px solid ${C.border}`, borderRadius: 10, padding: "20px 24px", marginBottom: 20 }}>
      <SectionLabel sub="Required CAGR trajectory vs conservative (60%) scenario">Compounding Curve to 2037</SectionLabel>
